...
- UI からの `POST /api/auth/login`、`GET /api/chats`、`POST /api/chats`、`GET /api/chats/{chatId}`、`DELETE /api/chats/{chatId}`、`POST /api/chats/{chatId}/messages`、`POST /api/chats/{chatId}/messages/{messageId}/correct` を受け付ける
