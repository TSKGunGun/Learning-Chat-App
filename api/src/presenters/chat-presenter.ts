import type { CreateChatWithFirstMessageResult } from "@/use-cases/create-chat-with-first-message-use-case";
import type { GetChatByIdResult } from "@/use-cases/get-chat-by-id-use-case";
import type { ChatChannelSummaryResult } from "@/use-cases/list-chats-use-case";
import type { SendMessageToChatResult } from "@/use-cases/send-message-to-chat-use-case";
...
export const presentCreateChat = (
...
export const presentChatDetail = (
  result: GetChatByIdResult
...
export const presentSendMessage = (
